      ...
      <div className="max-w-7xl mx-auto p-4 lg:p-6">
        ...
        {activeTab === 'dashboard' && (
          <div className="max-w-md mx-auto">
            ...
            <div className="bg-gradient-to-br from-[#76111b] to-[#c96378] rounded-3xl p-6 text-white shadow-2xl mb-6">
        ...
        {activeTab === 'documents' && (
          <div className="max-w-md mx-auto">
            <div className="bg-gradient-to-br from-[#c96378] to-[#e49daf] rounded-3xl p-6 text-white shadow-xl mb-6">
              <div className="flex items-center justify-between mb-6">
              ...
              <div className="space-y-3">
                {notes.length === 0 ? (
                  ...
                  notes.map((note, i) => (
                    <div key={note.id} className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 hover:bg-white/30 transition-all duration-200">
                      <div className="flex items-center gap-2 mb-2">
                        <div className={`w-8 h-6 rounded bg-gradient-to-r ${
                          i % 3 === 0 ? 'from-[#76111b] to-[#a3253a]' : 
                          i % 3 === 1 ? 'from-[#e49daf] to-[#edbec8]' : 
                      ...
                      <p className="text-xs opacity-80 line-clamp-2">{note.content}</p>
                    </div>
                  ))
                )}
              </div>
              ...
              <div className="grid grid-cols-7 gap-2">
                {Array.from({ length: 35 }, (_, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`aspect-square p-1 rounded-xl border transition-all duration-200 ${
                        isToday 
                    ...
                    >
                      <div className="h-full flex flex-col">
                        <span className={`text-xs mb-1 text-center ${isToday ? 'text-white' : 'text-gray-700'}`}>
                          {isCurrentMonth ? date : ''}
                        </span>
                        <div className="flex-1">
                          ...
                          {dayEvents.length > 1 && (
                            <div className={`text-[8px] ${isToday ? 'text-white' : 'text-gray-500'}`}>
                              +{dayEvents.length - 1}
                            </div>
                          )}
                        </div>
